...
export const SuperAdminDashboard: React.FC<SuperAdminDashboardProps> = ({
  ...
  const handleWithdrawRevenue = async (e: React.FormEvent) => {
    ...
    if (amount > data.superAdminEarnings.available_balance) {
      setWithdrawError(`Amount cannot exceed available revenue balance of ${formatNaira(data.superAdminEarnings.available_balance)}.`);
      return;
    }
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-2.5 flex-wrap">
          ...
          <button
            ...
            disabled={superAdminEarnings.available_balance <= 0}
            className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-extrabold shadow-md transition cursor-pointer ${
              superAdminEarnings.available_balance > 0
                ? 'bg-[#008751] hover:bg-[#007345] text-white shadow-[#008751]/20'
                : 'bg-slate-100 text-slate-400 cursor-not-allowed'
            }`}
          >
            <Wallet className="h-4 w-4" />
            <span>Withdraw Revenue ({formatNaira(superAdminEarnings.available_balance)})</span>
          </button>
      ...
      <div className="flex items-center gap-2 border-b border-slate-200 mb-6 overflow-x-auto">
        {[
          ...
          { id: 'earnings', label: `Super Admin Revenue (${formatNaira(superAdminEarnings.available_balance)})` },
          ...
          <div className="rounded-3xl bg-gradient-to-br from-slate-900 via-slate-900 to-emerald-950 p-6 text-white shadow-md">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5">
                ...
                >
                  Withdraw Payout ({formatNaira(superAdminEarnings.available_balance)})
                </button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6 pt-6 border-t border-white/10 text-xs">
              ...
              <div>
                ...
                <span className="text-lg font-black text-emerald-400 mt-0.5 block">
                  {formatNaira(superAdminEarnings.total_withdrawn)}
                </span>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    step="any"
                    min="100"
                    max={superAdminEarnings.available_balance}
                    value={withdrawAmount}
                    onChange={(e) => setWithdrawAmount(e.target.value)}
                    placeholder={`Max ${superAdminEarnings.available_balance}`}
                  ...
                  <button
                    type="button"
                    onClick={() => setWithdrawAmount(String(superAdminEarnings.available_balance))}
